...
async def test_writer():
    ...
    test_events = [
        {"symbol": "BTCUSDT", "side": "Buy", "size": "0.038", "price": "114826.80", "updatedTime": 1758132828134},
        {"symbol": "ETHUSDT", "side": "Sell", "size": "2.15", "price": "4488.54", "updatedTime": 1758132829000},
        {"symbol": "BTCUSDT", "side": "Buy", "size": "0.983", "price": "114387.70", "updatedTime": 1758132830000},
    ]
    ...
    if count > 0:
        ...
        for row in rows:
            ...
            usd_value = price * qty
            print(
                f"  {dt.strftime('%H:%M:%S')} | {symbol} | {side:4} | ${price:8,.2f} | {qty:8.3f} | ${usd_value:10,.2f}"
            )
