"""
Collector SOPR on-chain (blockchain explorer)
...
class SOPRBlockchainCollector:
    """Collecteur SOPR via explorer blockchain (ex: Glassnode, CryptoQuant, etc.)."""
    BASE_URL = "https://api.blockchain.com/v3/sopr"  # À adapter selon provider
    ...
    def fetch_sopr(self, symbol: str = "BTC") -> dict[str, Any] | None:
        ...
        try:
            ...
            print(f"Erreur SOPR Blockchain: {e}")
            return None
