...
class CryptoScheduler:
    ...
    def add_collector(self, collector, interval_seconds: int, jitter_percent: int | None = None) -> None:
        """
    ...
    def _job_executed(self, event):
        ...
        logger.debug(
            "Scheduled job completed", job_id=event.job_id, scheduled_run_time=event.scheduled_run_time.isoformat()
        )
    ...
    async def start(self) -> None:
        ...
        logger.info("CryptoScheduler started", job_count=job_count, collectors=list(self.collectors.keys()))
