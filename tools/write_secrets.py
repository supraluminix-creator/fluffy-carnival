...
SENSITIVE = {
    'BINANCE_API_KEY', 'BYBIT_API_KEY', 'CMC_API_KEY', 'COINMARKETCAP_API_KEY',
    'COINGECKO_API_KEY', 'CRYPTOCOMPARE_API_KEY', 'DUNE_API_KEY', 'ETHERSCAN_API_KEY',
    'INFURA_API_KEY', 'OPENAI_API_KEY', 'OPENROUTER_API_KEY', 'API_WRITE_KEY', 'BITQUERY_API_KEY'
}
...
def main() -> None:
    ...
    order = [
        'API_WRITE_KEY', 'OPENAI_API_KEY', 'OPENROUTER_API_KEY', 'BINANCE_API_KEY', 'BYBIT_API_KEY',
        'CMC_API_KEY', 'COINMARKETCAP_API_KEY', 'COINGECKO_API_KEY', 'CRYPTOCOMPARE_API_KEY',
        'DUNE_API_KEY', 'ETHERSCAN_API_KEY', 'INFURA_API_KEY', 'BITQUERY_API_KEY',
    ]
    for name in order:
