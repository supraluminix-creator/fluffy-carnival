...
MODULES = [
    ...
    "pipeline.metrics.signals",  # signals metrics
    "signals.drift_detector",  # drift detection metrics
]
...
EXPECTED = {
    ...
    "macro_errors",
    "macro_breaker_skip",
    "macro_latency_seconds",
    "defillama_success",
    "defillama_errors",
    "defillama_cache_hit",
    "defillama_cache_miss",
    "defillama_breaker_skips",
    "defillama_latency_seconds",
    "bybit_ws_connections",
    "bybit_ws_events",
    "bybit_ws_errors",
    "bybit_ws_latency_seconds",
    "bybit_ws_parse_errors",
    "bybit_ws_writer_errors",
    "bybit_oi_success",
    "bybit_oi_errors",
    "bybit_oi_latency_seconds",
    "orchestrator_executions",
    "orchestrator_duration_seconds",
    "orchestrator_last_run_timestamp",
    "orchestrator_collector_success",
    "orchestrator_collector_error",
    ...
    "onchain_success",
    "onchain_errors",
    "onchain_latency_seconds",
    "sentiment_success",
    "sentiment_errors",
    "sentiment_latency_seconds",
    "txcount_success",
    "txcount_errors",
    "txcount_latency_seconds",
    "sopr_fetch_success",
    "sopr_fetch_errors",
    "sopr_fetch_latency_seconds",
    "crypto_ready",
