...
@pytest.mark.parametrize("source,payload,expect_none", [
...
def test_fetch_sopr(monkeypatch, source: SOPRSource, payload: dict[str, Any], expect_none: bool):
    def fake_get(url: str, params: dict[str, Any] | None = None, headers: dict[str, str] | None = None, timeout: int = 10):  # noqa: D401
