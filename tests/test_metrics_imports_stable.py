...
EXPECTED_SYMBOLS = [
    # export
    'EXPORTS_TOTAL', 'EXPORT_ROWS_TOTAL',
    # collectors
    ...
    # breakers
    'HTTP_BREAKER_OPENS_TOTAL', 'CIRCUIT_BREAKER_OPEN_TOTAL',
    # db
    'DB_FILE_SIZE_BYTES', 'DB_FRAGMENTATION_RATIO',
    # system
    'HEARTBEAT_TICKS_TOTAL', 'MAINTENANCE_CYCLES_TOTAL',
    # errors
    'COLLECTOR_ERROR_TYPES_TOTAL',
    # helpers
    'collector_timing', 'fallback_tier_timing', 'init_metrics_if_enabled', 'ensure_metrics'
]
