...
def test_market_fallback_success(monkeypatch):
    calls = []
    class Resp1:
        def raise_for_status(self): raise httpx.ConnectError('fail')
        def json(self): return {}
    cmc_payload = {
        "data": {
            "BTC": {
                "quote": {"USD": {"price": 12345.0, "volume_24h": 10, "market_cap": 1_000_000, "market_cap_dominance": 55}}
            }
        }
    }
    class Resp2:
        def raise_for_status(self): return None
        def json(self): return cmc_payload
    ...
    class DynClient:
        ...
        async def get(self, url: str, headers=None, timeout: int = 10):
            ...
            return type('R', (), {
                ...
                'json': lambda self: {
                    'data': { 'ETH': { 'quote': { 'USD': { 'price': 2000, 'volume_24h': 1, 'market_cap': 2_000_000, 'market_cap_dominance': 18 }}}},
